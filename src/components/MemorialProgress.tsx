...
const MemorialProgress = ({ photosCount, onShare, onDownload }: MemorialProgressProps) => {
  ...
  const getEncouragingMessage = () => {
    if (photosCount === 0) return "Click a tile to share a cherished memory";
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-sm p-6 mb-8 animate-fade-in">
      <div className="flex items-center justify-between mb-4">
        <div className="text-left">
          ...
          <p className="text-sm text-gray-600">
            ...
            <span className="text-memorial-gray-dark"> / 25 memories shared</span>
          </p>
        </div>
        <div className="flex gap-2">
          <Button 
            ...
            variant="outline" 
            size="sm" 
            className="bg-white hover:bg-memorial-blue hover:text-white transition-colors"
          >
      ...
      <Progress 
        value={progress} 
        className="h-2 bg-memorial-gray-light"
      />
